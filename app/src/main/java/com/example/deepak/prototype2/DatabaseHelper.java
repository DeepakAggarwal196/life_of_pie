...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_USER_HOME_ADDRESS = "user_home_address";
    private static final String COLUMN_USER_WORK_ADDRESS = "user_work_address";
     ...
     * @param user
     */
    public void deleteUser(UserModal user) {
        SQLiteDatabase db = this.getWritableDatabase();
